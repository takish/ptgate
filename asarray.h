 ...
 * All rights reserved.
 *
 * $Id: asarray.h,v 1.1.1.1 2004/06/02 04:59:39 takashi Exp $
 */
...
int     asarray_create  (asarray **ppa);
void        asarray_destroy (asarray **ppa);

int     asarray_add    (asarray *pa, const char *key, const char *value);
void        asarray_remove (asarray *pa, const char *key);
int     asarray_lookup (asarray *pa, const char *key, char **value);
 ...
 */
const char* asarray_get_key_no(asarray *pa, int index);
